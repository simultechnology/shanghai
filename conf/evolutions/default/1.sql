...
alter table room_queue add constraint fk_room_queue_school_3 foreign key (school_id) references school (school_id);
create index ix_room_queue_school_3 on room_queue (school_id);
